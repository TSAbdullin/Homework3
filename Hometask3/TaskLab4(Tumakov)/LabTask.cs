...
namespace Hometask3.TaskLab4
{
    ...
    class LabTask
        {
        // ТУПАЯ РЕАЛИЗАЦИЯ(делал чисто в рамках практики), в файле AnotherRealization я написал на мой взгляд более ПРАВИЛЬНУЮ и ОПТИМАЛЬНУЮ реализацию
        public void NumInDate() // Упражнение 4.1, 4.2, 4.3, определяем какому дню соотвествует число, введенное пользователем
            {
